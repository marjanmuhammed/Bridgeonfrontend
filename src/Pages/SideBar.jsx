...
const Sidebar = ({ children }) => {
  ...
  const menuItems = [
    ...
    { id: "placements", label: "Placements", icon: User, color: "from-yellow-500 to-orange-500", path: "/placements" },
    { id: "reviews", label: "Reviews", icon: MessageSquare, color: "from-cyan-500 to-blue-500", path: "/review" },
    { id: "contact", label: "About Us", icon: MessageSquare, color: "from-rose-500 to-red-500", path: "/ContactUsPage" }
  ];
  ...
  const toggleFluidCursor = () => {
    setShowFluidCursor(!showFluidCursor);
  };
  ...
  return (
    <div className={`flex h-screen relative ${isDarkMode ? 'dark' : 'light'}`}>
      {/* Fluid Cursor Effect */}
      {showFluidCursor && <FluidCursor />}

      {/* Sidebar */}
      <div className={`relative h-full transition-all duration-300 ${isCollapsed ? 'w-20' : 'w-64'} flex flex-col shadow-2xl z-40
        ${isDarkMode 
        ...
        {/* Logo Section */}
        <div className={`p-6 ${isDarkMode ? 'border-b border-slate-700/50' : 'border-b border-gray-200/50'}`}>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-4 px-4 py-3.5 rounded-xl transition-all duration-200 group relative overflow-hidden
                  ${isActive 
                    ? `bg-gradient-to-r ${item.color} shadow-lg scale-105 text-white` 
                    : isDarkMode 
              ...
              >
                ...
                {isCollapsed && (
                  <div className={`absolute left-full ml-4 px-3 py-2 text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap shadow-xl z-50 ${
                    isDarkMode 
        ...
        {/* Bottom Section */}
        <div className={`p-3 space-y-2 ${isDarkMode ? 'border-t border-slate-700/50' : 'border-t border-gray-200/50'}`}>
          ...
          >
            ...
            {!isCollapsed && (
              <span className="font-medium text-sm">
                {showFluidCursor ? 'Hide Effects' : 'Show Effects'}
              </span>
            )}
          </button>
      ...
      {/* Main content */}
      <div className={`flex-1 overflow-auto relative transition-colors duration-300 ${
        isDarkMode 
